...
import { cancellable, type Fn, type JSONValue, } from "@easy/2725_interval_cancellation.js";
    ...
    const testSamples = [
        {
            ...
            t: 35,
            cancelTimeMs: 190,
            expected: [{"time":0,"returned":8},{"time":35,"returned":8},{"time":69,"returned":8},{"time":104,"returned":8},{"time":139,"returned":8},{"time":175,"returned":8}]
        },
        {
            fn: fnTwo,
            args: [2,5],
            t: 30,
            cancelTimeMs: 165,
            expected: [{"time":0,"returned":10},{"time":30,"returned":10},{"time":60,"returned":10},{"time":90,"returned":10},{"time":121,"returned":10},{"time":151,"returned":10}]
        },
        {
            fn: fnThree,
            args: [5, 1, 3],
            t: 50,
            cancelTimeMs: 180,
            expected: [{"time":0,"returned":9},{"time":50,"returned":9},{"time":100,"returned":9},{"time":150,"returned":9}]
        }
    ]
