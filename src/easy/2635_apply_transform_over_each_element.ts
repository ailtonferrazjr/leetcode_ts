...
function emptyArrayApproach (arr: number[], fn: (n: number, i: number) => number): number[] {
...
function forInLoopApproach(arr: number[], fn: (n: number, i: number) => number): number[] {
...
function pushValuesIntoArrayApproach(arr: number[], fn: (n: number, i: number) => number): number[] {
...
function preAllocatedMemory(arr: number[], fn: (n: number, i: number) => number): number[] {
...
function primitiveArray(arr: number[], fn: (n: number, i: number) => number): number[] {
...
function inMemoryAllocation(arr: number[], fn: (n: number, i: number) => number): number[] {
    for (let i = 0; i < arr.length; i++) {
        arr[i] = fn(arr[i],i);
    }
    return arr;
