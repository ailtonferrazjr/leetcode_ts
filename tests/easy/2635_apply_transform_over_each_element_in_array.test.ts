...
import { mapFunctions } from "@easy/2635_apply_transform_over_each_element_in_array.js";
...
describe("2635 - Apply Transform Over Each Element", () => {
	...
	test.each(testSample)(
		...
		({
			...
			expect(mapFunctions.primitiveArray(arr, fn)).toEqual(
				new Int32Array(output),
			);
